export class Sourdough {
    ...
    public feed(): void {
        ...
        this.timer = setTimeout(() => { this.sendMessage(`Please make autolyse! Type <strong> sourdough autolyse </strong> to confirm`) } , 120 * 60 * 1000);
    }
    ...
    public autolyse(): void {
        ...
        this.timer = setTimeout(() => {this.sendMessage(`You need to check if sourdough is peeking! Type <strong> sourdough mix </strong> to confirm that you have assembled the autolyse dough and sourdough`) } , Date.now() - this.feedTime + 4 * 60 * 60 * 1000);
    }
    ...
    public sourdoughMix(): void {
        ...
        this.timer = setTimeout(() => { this.sendMessage(`The dough is ready to be baked!!`) } , 8 * 60 * 60 * 1000);
    }
}